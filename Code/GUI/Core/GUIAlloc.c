...
//GUI_HEAP GUI_Heap __attribute__((at(0x10000000)));         /* Public for debugging only */

//static tBlock aBlock[GUI_MAXBLOCKS] __attribute__((at(0x10000000 + (GUI_ALLOC_SIZE)))); /*sizeof(tBlock) = 12*/

CCMRAM GUI_HEAP GUI_Heap;         /* Public for debugging only */

CCMRAM static tBlock aBlock[GUI_MAXBLOCKS]; /*sizeof(tBlock) = 12*/
